...
sudo sed -i 's/Server=enceladus.pfsense.cz/Server=192.168.1.2/g' /etc/zabbix/zabbix_agent2.conf
sudo sed -i 's/ServerActive=enceladus.pfsense.cz/ServerActive=192.168.1.2/g' /etc/zabbix/zabbix_agent2.conf
